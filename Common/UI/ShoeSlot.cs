...
public class ShoeSlot : ModAccessorySlot
{
	...
	public override bool CanAcceptItem(Item checkItem, AccessorySlotType context) => ShoeSystem.Shoes.Contains(checkItem.type);

	public override bool ModifyDefaultSwapSlot(Item item, int accSlotToSwapTo) => ShoeSystem.Shoes.Contains(item.type);
